...
var MerchantLib = function() {
    ...
    this.testStub = function (testCounterModel, testMerchantModel, testJWT, testLogger) {
        Counter = testCounterModel;
        Merchant = testMerchantModel;
        jwt = testJWT;
        logger = testLogger;
        //merchantMap = testMerchantMap;
        //merchantCounter = testMerchantCounter;
    };
};
